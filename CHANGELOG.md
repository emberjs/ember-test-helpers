...
#### :bug: Bug Fix
* `@ember/test-helpers`
  * [#1569](https://github.com/emberjs/ember-test-helpers/pull/1569) Remove macros ([@NullVoxPopuli](https://github.com/NullVoxPopuli))
...
#### :house: Internal
* `@ember/test-helpers`
  * [#1565](https://github.com/emberjs/ember-test-helpers/pull/1565) Ember 7 compat ([@NullVoxPopuli](https://github.com/NullVoxPopuli))
* Other
