...
declare const Owner_base: Readonly<typeof EmberObject> & (new (owner?: import("@ember/owner").default) => EmberObject) & import("@ember/object/mixin").default;
declare class Owner extends Owner_base {
