...
if (typeof globalThis.jQuery !== 'undefined' && _internalPendingRequestsModule) {
  ...
  EmberApplicationInstance.reopen({
    willDestroy(...args) {
      globalThis.jQuery(document).off('ajaxSend', _internalPendingRequestsModule.incrementPendingRequests);
      globalThis.jQuery(document).off('ajaxComplete', _internalPendingRequestsModule.decrementPendingRequests);
