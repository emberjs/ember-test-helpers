...
import { s as settled, g as getContext, i as isTestContext } from './setup-context-DegmztrF.js';
...
import renderComponent from './-internal/render-component.js';
...
function renderViaRenderComponent(owner, context, templateFactoryOrComponent, options) {
  ...
  if (ownerToRenderFrom === owner && typeof owner.renderRootComponent === 'function') {
    run(() => owner.renderRootComponent(component));
  } else {
