...
export default TestModule.extend({
  init: function(name, description, callbacks) {
    ...
    this._super.call(this, 'component:' + name, description, callbacks);
  ...
  setupComponent: function() {
    ...
    var layoutName = 'template:components/' + this.baseName;

    var layout = resolver.resolve(layoutName);

    if (layout) {
      container.register(layoutName, layout);
      container.injection(this.name, 'layout', layoutName);
    }
